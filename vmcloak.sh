...
sleep 5
#--hwvirt
vmcloak init --vm-visible --ramsize 2048 –cpus 2 -ip $ipaddress --serial-key $key --cuckoo /etc/cuckoo-modified/utils/machine.py --iso-mount /mnt/windows_ISOs/ $name &>> $logfile
